export const FORENSIC_MATRIX = [
  ...
  { 
    ...
    text: "Is there a structured review process to validate third-party API model updates before they impact operational workflows?", 
    evidenceOptions: ["SOP_DOCUMENT", "STEERCO_MINUTES", "VERBAL_ASSURANCE", "NONE"] 
  },
  { 
    id: "TEC_01", lens: "TEC", triangulationId: "T1", weight: 15, 
    text: "Do engineering systems maintain automated logging to trace every payload and context vector ingested into third-party AI models?", 
  ...
  { 
    ...
    text: "Does corporate leadership measure and track the Process Waste Tax (sprint capacity lost to fixing unmapped data drift)?", 
    evidenceOptions: ["FINANCIAL_REPORT", "WASTE_TAX_LEDGER", "ANECDOTAL", "NONE"] 
  },
  { 
    id: "MGR_02", lens: "MGR", triangulationId: "T2", weight: 15, 
    text: "Are subject matter experts spending weekly capacity manually correcting drifting schemas or AI model outputs?", 
    evidenceOptions: ["TIME_TRACKING", "SME_INTERVIEWS", "VALIDATION_LOGS", "NONE"] 
  },
  { 
    id: "TEC_02", lens: "TEC", triangulationId: "T2", weight: 13, 
    text: "Is there an automated feedback mechanism that refines context pipelines based on human validation edits?", 
  ...
  { 
    ...
    text: "Is there an executive policy governing unhedged AI tools and restricting unauthorized enterprise data ingestion?", 
    evidenceOptions: ["EMPLOYEE_HANDBOOK", "BOARD_DIRECTIVE", "VERBAL_POLICY", "NONE"] 
  },
  { 
    id: "MGR_03", lens: "MGR", triangulationId: "T3", weight: 10, 
    text: "Has operational leadership established human-in-the-loop guidelines for separating safe versus restricted AI prompt contexts?", 
    evidenceOptions: ["TRAINING_LOGS", "SECURITY_BRIEFING", "NONE"] 
  },
  { 
    id: "TEC_03", lens: "TEC", triangulationId: "T3", weight: 15, 
    text: "Are API gateways and network boundaries configured to detect and govern unauthorized AI endpoint traffic?", 
  ...
  { 
    ...
    text: "Does governance maintain formal verification of IP ownership and context boundary rights for automated AI outputs?", 
    evidenceOptions: ["LEGAL_OPINION", "VENDOR_AGREEMENT", "NONE"] 
  },
  { 
    id: "MGR_04", lens: "MGR", triangulationId: "T4", weight: 8, 
    text: "Are operational teams instructed to run sanitization checks on AI outputs to preserve proprietary standards?", 
    evidenceOptions: ["SOP_DOCUMENT", "WORKFLOW_GUIDE", "NONE"] 
  },
  { 
    id: "TEC_04", lens: "TEC", triangulationId: "T4", weight: 12, 
    text: "Do automated pipelines attach cryptographic metadata or watermarks to track context vectors across value streams?", 
  ...
  { 
    ...
    text: "Does enterprise AI usage enforce inline data loss prevention (DLP) and PII masking to comply with privacy standards?", 
  ...
  { 
    ...
    text: "Is there an inline PII-stripping layer running between user interfaces and third-party LLM endpoints?", 
  ...
  { 
    ...
    text: "Is operational management tracking accuracy degradation or schema drift failures in automated workflows?", 
  ...
  { 
    ...
    text: "Has leadership defined explicit risk allowance ceilings and liability parameters for automated decision errors?", 
    evidenceOptions: ["RISK_REGISTER", "INSURANCE_POLICY", "NONE"] 
  },
  { 
    id: "MGR_07", lens: "MGR", triangulationId: "T7", weight: 10, 
    text: "Is there an operational override protocol to pause automated workflows if logic drift or hallucinations trigger?", 
  ...
  { 
    ...
    text: "Is financial return and capital leakage from AI initiatives tracked on executive and SteerCo dashboards?", 
    evidenceOptions: ["P&L_STATEMENT", "PROMISE_GAP_MODEL", "NONE"] 
  },
  { 
    id: "MGR_08", lens: "MGR", triangulationId: "T8", weight: 8, 
    text: "Do operational leads have real-time visibility into monthly API and token costs generated by their teams?", 
    evidenceOptions: ["DASHBOARD_ACCESS", "MONTHLY_BILL_ANALYSIS", "NONE"] 
  },
  { 
    id: "TEC_08", lens: "TEC", triangulationId: "T8", weight: 12, 
    text: "Are API calls dynamically tagged by microservice and department to monitor unit economics and manage spend?", 
  ...
  { 
    ...
    text: "Is there a strategic communication plan to manage human-in-the-loop transitions without operational friction?", 
  ...
  { 
    ...
    text: "Is engineering capacity allocated to building pre-automation control planes versus resolving active API errors?", 
  ...
  { 
    ...
    text: "Does the enterprise maintain a model-agnostic strategy to prevent single-vendor lock-in across AI pipelines?", 
  ...
  { 
    ...
    text: "Has technical engineering tested hot-swapping or emergency failovers to secondary model providers?", 
