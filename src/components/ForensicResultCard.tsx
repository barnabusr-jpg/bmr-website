...
// Import using the NEW name and direct relative path
        ...
        <div className="p-12 space-y-12 flex-grow">
          <div className="flex justify-between items-center pb-12 border-b border-slate-900/50">
              <div className="space-y-2">
                  ...
                  <p className="text-4xl font-black italic text-red-600">${result.reworkTax || '1.1M'}<span className="text-xs text-slate-500 ml-1">/YR</span></p>
              </div>
              <div className="text-right space-y-2">
                  <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest italic">6-Month Inaction Cost</p>
                  <p className="text-4xl font-black italic text-white">${result.inactionCost || '0.62M'}</p>
              </div>
          </div>
          ...
          {/* CTA: TRIGGERING THE NEW DOSSIER ENGINE (v7.0) */}
          <div className="print:hidden">
            ...
            >
              <FileText size={18} /> Download Forensic Briefing (v7.0)
            </button>
          </div>
        </div>
