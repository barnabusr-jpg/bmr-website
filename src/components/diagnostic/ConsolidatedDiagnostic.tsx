      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'audit' && (
          <motion.div key="audit" className="space-y-12 text-left">
            <div className="flex items-center gap-4 text-red-600 font-black uppercase tracking-[0.4em] text-[10px]"><Activity size={16} className="animate-pulse" /> PULSE_SEGMENT_0{currentDimension + 1}</div>
