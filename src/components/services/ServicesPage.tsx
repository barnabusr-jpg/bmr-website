        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive advisory services designed to guide your organization
              through every stage of responsible AI adoption, from strategic
              planning to measurable outcomes.
            </p>
          </motion.div>
