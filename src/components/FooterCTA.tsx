  ...
  return (
    <section className="py-32 bg-[#020617] border-t border-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-slate-400 mb-12 max-w-2xl mx-auto font-light text-xl leading-relaxed italic">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          <Button 
            className="bg-[#14b8a6] hover:bg-[#0d9488] text-[#020617] font-bold h-16 px-12 text-lg transition-all duration-300 shadow-[0_0_30px_rgba(20,184,166,0.15)] group uppercase italic rounded-none"
