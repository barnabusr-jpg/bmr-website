    ...
    <>
      <header className="fixed top-0 left-0 right-0 h-20 md:h-24 bg-[#020617]/95 backdrop-blur-xl border-b border-slate-900 z-[1000] flex items-center justify-between px-6 md:px-12">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          >
            {/* Shortens text on mobile, full text on desktop */}
            <span className="hidden sm:inline">START_PULSE_CHECK</span>
            <span className="sm:hidden">PULSE_CHECK</span>
      ...
      {/* --- MOBILE NAV OVERLAY (The Forensic Drawer) --- */}
      <div 
