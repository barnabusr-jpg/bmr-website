  ...
  return (
    <header className="fixed top-0 w-full z-40 bg-[#020617]/80 backdrop-blur-md border-b border-slate-900">
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="font-bold text-2xl tracking-tighter uppercase tracking-wide">BMR<span className="text-[#14b8a6]">ADVISORY</span></Link>
        ...
        <Button onClick={() => router.push('/diagnostic')} className="bg-white text-black font-bold hover:bg-[#14b8a6] hover:text-white transition-all text-xs px-6 uppercase">Start Diagnostic</Button>
      </div>
    </header>
  );
}
