      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-slate-900 border-2 border-slate-900">
          {SERVICES.map((service, index) => (
            <Link key={index} href={service.href} className="group block no-underline">
              <div className="bg-[#020617] p-16 hover:bg-red-600/[0.02] transition-all relative flex flex-col justify-between min-h-[550px]">
                ...
                <div className="space-y-10 text-left">
                  ...
                  <h3 className="text-4xl font-black text-white italic uppercase tracking-tight group-hover:text-red-600 transition-colors leading-none">
                    {service.title}
                  </h3>
                  <p style={{ fontSize: '1.5rem', lineHeight: '1.6' }} className="text-slate-500 font-medium italic border-l-2 border-slate-800 pl-8">
                    {service.description}
                  </p>
                </div>
                <div className="inline-flex items-center gap-4 text-xs font-black uppercase tracking-[0.3em] text-slate-700 group-hover:text-white transition-all mt-16">
