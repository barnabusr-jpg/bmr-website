              ...
              >
                <Card className={`p-8 h-full border-2 transition-all duration-500 relative overflow-hidden group ${
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <div className={`text-3xl font-bold tracking-tighter transition-colors duration-300 italic uppercase ${
                  ...
                  <h4 className="text-xl font-bold mb-3 text-white tracking-tight italic uppercase">
                    {m.fullName}
                  </h4>
                  ...
                  <div className="mt-auto pt-4 border-t border-slate-800/50">
                    <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#14b8a6]">
                      Lens Classification: <span className={isSelected ? "text-white" : ""}>{m.category}</span>
                    </div>
                  </div>
                </Card>
              </div>
