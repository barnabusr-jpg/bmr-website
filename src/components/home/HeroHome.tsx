...
export default function HeroHome() {
  ...
  return (
    <section className="bg-[#020617] text-white pt-32 pb-16 md:pt-56 md:pb-32 w-full overflow-hidden text-left italic">
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-[55%] shrink-0">
          <div className="border-l-[6px] border-red-600 pl-6 md:pl-10 mb-10 md:mb-16">
            <p className="text-red-600 font-black text-[10px] md:text-xs tracking-[0.5em] mb-5 font-mono uppercase italic">NODE_ACCESS: BMR_SOLUTIONS_FORENSIC_UNIT</p>
          ...
          <div className="border-t border-[#1e293b] pt-10 max-w-[550px]">
            <span className="text-red-600 font-black text-[11px] tracking-[0.4em] font-mono uppercase italic">Systemic Decay:</span>
            ...
            <button 
              ...
              className="mt-10 bg-red-600 text-white py-5 px-10 md:py-6 md:px-12 font-black uppercase tracking-[0.3em] text-[11px] hover:bg-white hover:text-black transition-all flex items-center gap-4 shadow-2xl italic"
            >
        ...
        <div className="w-full lg:w-[40%] mt-8 lg:mt-24 shrink-0">
          <div className="bg-[#0f172a]/40 border-2 border-[#1e293b] p-8 md:p-14 relative overflow-hidden shadow-2xl">
            ...
            <div className="border-l-2 border-red-600 pl-6 md:pl-8 mt-10">
              <p className="text-slate-400 italic text-lg md:text-xl font-bold uppercase italic">
