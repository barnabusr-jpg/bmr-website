      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 40px', display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: '60px' }}>
        ...
        <div style={{ width: '55%', textAlign: 'left', flexShrink: 0 }}>
          <div style={{ borderLeft: '6px solid #dc2626', paddingLeft: '40px', marginBottom: '60px' }}>
            ...
            <h1 style={{ fontSize: 'clamp(4rem, 9vw, 8rem)', fontWeight: 900, fontStyle: 'italic', lineHeight: 0.8, textTransform: 'uppercase', margin: 0, fontFamily: 'sans-serif', letterSpacing: '-0.02em' }}>
        ...
        {/* RIGHT COLUMN: REFINED PERSONA BOX */}
        <div style={{ width: '40%', marginTop: '40px', flexShrink: 0 }}>
          <div style={{ 
            backgroundColor: 'rgba(15, 23, 42, 0.4)', 
            border: '2px solid #1e293b', 
            padding: '80px 60px', // Increased top/bottom padding to remove cramped feel
            textAlign: 'left', 
            position: 'relative' 
          }}>
            <div style={{ position: 'absolute', top: 0, right: 0, width: '40px', height: '40px', borderTop: '2px solid #dc2626', borderRight: '2px solid #dc2626' }} />
            
            <h2 style={{ fontSize: '2.5rem', fontWeight: 900, fontStyle: 'italic', textTransform: 'uppercase', margin: 0, fontFamily: 'sans-serif', lineHeight: 1.1, color: 'white' }}>
              For <span style={{ color: '#dc2626' }}>CTOs / OPs &<br />Tech Mgrs</span>
            </h2>

            <div style={{ borderLeft: '2px solid #dc2626', paddingLeft: '30px', marginTop: '50px' }}>
              <p style={{ color: '#94a3b8', fontStyle: 'italic', fontFamily: 'sans-serif', fontSize: '1.2rem', lineHeight: 1.6, marginBottom: '30px' }}>
              ...
              <div style={{ borderTop: '1px solid #1e293b', paddingTop: '30px' }}>
                <p style={{ color: '#dc2626', fontWeight: 900, textTransform: 'uppercase', fontFamily: 'sans-serif', fontSize: '1.3rem', letterSpacing: '0.05em' }}>
