      ...
      <div className="max-w-7xl mx-auto px-10">
        <div className="border-l-6 border-red-600 pl-10 mb-20 text-left">
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-red-600 font-black uppercase tracking-[0.4em] text-[10px]">FORENSIC_INTELLIGENCE_BRIEFINGS</span>
          </div>
          <h2 className="text-6xl md:text-8xl font-black text-white italic uppercase tracking-tighter">FORENSIC <br />ANALYSIS</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {signalEntries.map((insight) => (
            ...
            >
              <div className="p-12 border-2 border-slate-900 bg-slate-950/20 h-full flex flex-col justify-between hover:border-red-600/40 transition-all">
                <div>
                ...
                <div className="mt-12 text-red-600 font-black text-[10px] tracking-[0.2em] uppercase flex items-center gap-3 group-hover:gap-6 transition-all">
                  ACCESS FORENSIC BRIEFING <ArrowRight size={14} />
                </div>
              </div>
            </Link>
          ))}
