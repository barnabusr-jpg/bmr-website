      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="border-l-4 md:border-l-6 border-red-600 pl-6 md:pl-10 mb-12 md:mb-20 text-left">
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-red-600 font-black uppercase tracking-[0.4em] text-[9px] md:text-[10px]">FORENSIC_INTELLIGENCE_DISTRIBUTION</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
          {signalEntries.map((insight) => (
            ...
            >
              <div className="p-8 md:p-12 border-2 border-slate-900 bg-slate-950/20 h-full flex flex-col justify-between hover:border-red-600/40 transition-all text-left">
                <div>
                  <div className="flex items-center gap-3 text-red-600 mb-6 md:mb-8">
                    <Activity size={18} />
                    <span className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-500">PROTOCOL: {insight.category}</span>
                  </div>
                  <h3 className="text-2xl md:text-4xl font-black text-white italic uppercase mb-6 md:mb-8 leading-tight">{insight.title}</h3>
                ...
                <div className="mt-10 md:mt-12 text-red-600 font-black text-[9px] md:text-[10px] tracking-[0.2em] uppercase flex items-center gap-3 group-hover:gap-5 transition-all">
