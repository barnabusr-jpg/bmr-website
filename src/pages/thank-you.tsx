    ...
    <div className="min-h-screen bg-[#020617] text-white font-sans">
      ...
      <main className="py-24 px-6 container mx-auto max-w-5xl text-left">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-tighter font-display">Observation Recorded. <br/><span className="text-slate-500">Your Synthesis is in progress.</span></h1>
        </div>

        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="md:col-span-2 space-y-6">
            <Card className="p-8 bg-slate-900/40 border-slate-800 border-2 text-white">
              <div className="flex items-center gap-3 mb-6">
                <TrendingUp className="text-[#14b8a6]" size={20} />
                <h3 className="text-xl font-bold font-display text-white">What happens next?</h3>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-lg border border-slate-800 bg-slate-950/50 flex flex-col justify-center">
                <h4 className="font-bold text-[#14b8a6] mb-1 uppercase tracking-wider text-xs">Advisory Review</h4>
          ...
          <Card className="p-8 bg-[#14b8a6] text-black border-none flex flex-col justify-between">
            <div>
              <h3 className="text-2xl font-bold mb-4 leading-tight font-display tracking-tight text-black">Bridge the Gap.</h3>
            ...
            <Link href="/contact" className="w-full">
              <Button className="w-full bg-black text-white font-bold h-14 hover:bg-slate-800 transition-colors uppercase text-xs tracking-widest">Book Briefing <ArrowRight className="ml-2" size={18} /></Button>
            </Link>
          </Card>
        </div>
      </main>
