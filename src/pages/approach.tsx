      ...
      <main className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-32 items-center">
            ...
            <div className="bg-slate-900/40 border border-slate-800 p-8 rounded-3xl min-h-[300px] flex items-center justify-center text-slate-500 font-mono text-xs uppercase tracking-widest text-center">
