...
<section className="max-w-7xl mx-auto px-6 mb-24 flex flex-col items-center text-center">
  <span className="text-[#14b8a6] font-bold uppercase tracking-[0.3em] text-[10px] mb-4 block">
    The Strategic Baseline
  </span>
  <h1 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter leading-none text-white mb-8">
