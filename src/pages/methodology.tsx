      ...
      <main className="pt-44 pb-24 px-6 max-w-7xl mx-auto italic"> 
        ...
        <section className="mb-40 bg-white text-slate-950 p-10 md:p-24 italic"> 
          <div className="max-w-4xl italic text-slate-950"> 
            {/* NAMING UPDATE */}
            <h2 className="text-5xl md:text-7xl font-black italic tracking-tighter leading-none mb-10 italic uppercase">THE 3 MINUTE <span className="text-red-600 italic">FORENSIC AUDIT.</span></h2> 
