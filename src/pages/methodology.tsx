      ...
      <main className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
        <section className="mb-20">
          ...
          <p className="text-slate-400 text-xl max-w-3xl leading-relaxed font-light">
            We solve the systemic friction between human potential and AI. 
            Our framework closes the <span className="text-white italic">Promise Gap™</span>—the space between strategic intent and operational reality.
          </p>
        </section>

        <div className="grid md:grid-cols-3 gap-8 mb-24 text-sm font-light leading-relaxed">
          <div className="p-8 bg-slate-900/40 border border-slate-800 rounded-lg relative overflow-hidden group">
            ...
            <p className="text-slate-400"><strong>The Foundation:</strong> Anchoring systems by ensuring adoption begins with empathy and transparency. Without trust, systems fail to scale.</p>
          </div>
          <div className="p-8 bg-slate-900/40 border border-slate-800 rounded-lg relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-[#14b8a6]"></div>
            ...
            <p className="text-slate-400"><strong>The Bridge:</strong> Translating raw adoption metrics into measurable mission impact by linking intent to actual frontline outcomes.</p>
          </div>
          <div className="p-8 bg-slate-900/40 border border-slate-800 rounded-lg relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-[#14b8a6]"></div>
            ...
            <p className="text-slate-400"><strong>The Safeguard:</strong> Embedding accountability into every decision loop, creating an environment for rapid, responsible evolution.</p>
          </div>
        </div>
        ...
        <section className="p-12 bg-[#14b8a6]/5 border border-[#14b8a6]/20 rounded-2xl text-center">
          ...
          <p className="text-slate-300 mb-10 font-light max-w-2xl mx-auto leading-relaxed">
            Our operational reference manual for stabilizing AI initiatives. This guide explains the 
            twelve distinct signals we track to identify and bridge the Promise Gap™.
          </p>
          <a href="/media/Field Guide.pdf" download className="inline-flex items-center gap-4 bg-[#14b8a6] text-[#020617] px-10 py-5 rounded font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#0d9488] transition-all">
