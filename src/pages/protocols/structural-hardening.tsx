  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-blue-500/30 font-sans text-left">
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="flex justify-center gap-6">
            <button 
              ...
              className="bg-blue-600 hover:bg-white text-white hover:text-blue-600 px-10 py-5 font-black uppercase text-[11px] tracking-[0.4em] transition-all italic flex items-center gap-3"
            >
          ...
          <div className="grid md:grid-cols-2 gap-px bg-slate-900/50 border border-slate-900">
            <div className="bg-slate-950 p-12 space-y-8 text-left">
              <div className="flex items-center gap-3 text-blue-500 text-left">
                <Shield size={20} />
      ...
      <ActivationModal 
        ...
        protocolName="STRUCTURAL HARDENING"
      />
      <Footer />
    </div>
  );
