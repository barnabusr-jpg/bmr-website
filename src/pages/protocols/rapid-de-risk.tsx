      ...
      <main className="pt-44 pb-24 px-6 text-left">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center">
            {/* 🛠️ RED PULSING PROTOCOL INDICATOR */}
            <motion.div
          ...
          <div className="flex justify-center gap-6">
            <button className="bg-red-600 hover:bg-white text-white hover:text-red-600 px-10 py-5 font-black uppercase text-[11px] tracking-[0.4em] transition-all italic flex items-center gap-3">
