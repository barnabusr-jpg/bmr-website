    ...
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-[#14b8a6]/30">
      ...
      <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-slate-400 font-light leading-relaxed border-t border-slate-900 pt-12">
          <section>
            <h2 className="text-xl font-bold text-white mb-4 uppercase tracking-wide leading-tight">1. Intellectual Property & Trade Secrets</h2>
          ...
          <section className="p-8 border border-slate-800 bg-slate-900/40 rounded-lg relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#14b8a6]/50 to-transparent"></div>
            <h2 className="text-xl font-bold text-white mb-4 uppercase tracking-wide italic leading-tight">2. Advisory Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4 uppercase tracking-wide leading-tight">3. Governing Law & Venue (Fairfax County)</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4 uppercase tracking-wide leading-tight">4. Contact & Inquiries</h2>
            <p className="mb-6">
