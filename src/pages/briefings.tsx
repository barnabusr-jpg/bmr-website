...
const BRIEFINGS = [
  {
    id: "B-01",
    title: "MODEL COLLAPSE AND REWORK TAX",
    tag: "FORENSIC DECAY",
    ...
    pages: 18,
    desc: "Analysis of recursive AI training loops creating a 40 percent increase in Logic Rot across enterprise models.",
  ...
  {
    id: "B-03",
    title: "LOGIC AUTHORITY AND LIABILITY",
    tag: "LEGAL FORENSICS",
              ...
              >
                ...
                <div className="space-y-6 z-10">
                  ...
                  <div className="space-y-3">
                    <h2 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter group-hover:text-red-600 transition-colors leading-none text-white">
                      {brief.title}
                    </h2>
