...
export default function DiagnosticResults() {
  ...
  useEffect(() => {
    ...
    if (baseline) {
      ...
      // Execute the static Forensic Engine calculation
              ...
              <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed italic">
                    &quot;Your ${result.financials.estimate.toLocaleString()} hemorrhage is a compounding liability. When you automate a {data.integrity.toUpperCase()} baseline, hidden costs scale this to <span className="text-white font-bold">$20.4M</span> by Q4 2026.&quot;
                  </p>
                  <button 
                ...
                <div className="bg-slate-900/40 p-8 border border-slate-800 space-y-6 relative overflow-hidden text-[10px] font-mono uppercase tracking-widest">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-red-600 italic">Total Liability</span><span className="text-red-600">$20.4M</span>
                  </div>
                </div>
              </section>
