...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-red-500/30">
      <Head><title>BMR | AI FORENSIC & HARDENING</title></Head>
      <Header />
      <main>
        <Hero />
        ...
        <section className="py-32 px-6 border-t border-slate-900 bg-[#020617]">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-5xl md:text-7xl font-black mb-12 italic tracking-tighter uppercase text-white leading-none">
              READY TO <br /><span className="text-red-600 uppercase">CLOSE THE GAP?</span>
            </h2>
            <div className="max-w-2xl mx-auto text-left">
              <div className="p-10 bg-red-950/5 border-2 border-red-900/20 hover:border-red-600/40 transition-all duration-500 group relative overflow-hidden">
                ...
                <h3 className="text-3xl font-black mb-4 italic uppercase text-white tracking-tight">SYSTEM DIAGNOSTIC</h3>
                <p className="text-slate-400 mb-10 text-sm italic uppercase tracking-tight">Identify your primary friction points. Secure your operational integrity now.</p>
                <button onClick={() => router.push('/pulse-check/assessment')} className="w-full inline-flex items-center justify-center gap-3 bg-red-600 text-white px-8 py-7 font-black uppercase tracking-[0.3em] text-[11px] hover:bg-white hover:text-red-600 transition-all">
