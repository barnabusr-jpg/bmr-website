      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#14b8a6]/10 border border-[#14b8a6]/20 text-[#14b8a6] text-xs font-bold uppercase tracking-widest mb-8">
            <Zap size={14} /> The Promise Gap&trade; Diagnostic
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-8 font-display leading-tight">
            Recover the Value of <br/><span className="text-[#14b8a6]">Stranded AI Assets.</span>
          </h1>
          <p className="text-slate-400 text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Identify the specific friction points where your AI investment is leaking into human labor.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Begin Observation <ArrowRight className="ml-2" />
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 border-t border-slate-900 bg-slate-950/50">
        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-sm">Eliminate the manual verification labor that hides negative ROI.</p>
          </div>
          <div className="space-y-4">
            <BarChart3 className="text-[#14b8a6]" size={32} />
            <h3 className="text-xl font-bold">Govern</h3>
            <p className="text-slate-400 text-sm">Institutionalize AI reliability so performance doesn&apos;t depend on a single expert.</p>
          </div>
          <div className="space-y-4">
