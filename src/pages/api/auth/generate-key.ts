...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const msg = {
      ...
      // CLEANED SUBJECT: No underscores, Solutions branding
      subject: `NODE AUTHORIZATION: ${otp} // BMR SOLUTIONS`,
      html: `
        <div style="font-family: 'Courier New', Courier, monospace; background-color: #020617; color: white; padding: 60px; border: 2px solid #dc2626; max-width: 600px; margin: auto;">
          <h2 style="color: #dc2626; text-transform: uppercase; font-style: italic; letter-spacing: -1px; margin-bottom: 5px;">BMR SOLUTIONS // NODE AUTHORIZATION</h2>
          <p style="color: #64748b; text-transform: uppercase; font-size: 10px; margin-top: 0; letter-spacing: 2px;">PROTOCOL: PULSE CHECK VERIFICATION</p>
          
          <hr style="border: 0; border-top: 1px solid #1e293b; margin: 30px 0;"/>
          
          <p style="font-size: 14px; line-height: 1.6; color: #cbd5e1;">A forensic diagnostic session has been requested. Enter the following challenge key to initialize the node:</p>
          ...
          <p style="color: #475569; font-size: 10px; text-transform: uppercase; letter-spacing: 1px;">
            SECURITY NOTICE: BMR PROTOCOL 7 ACTIVE // DO NOT SHARE THIS KEY // EXPIRES IN 5M
          </p>
          
          <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #1e293b;">
             <p style="font-size: 9px; color: #334155;">CONFIDENTIAL // BMR SOLUTIONS ENCRYPTION ACTIVE</p>
          </div>
        </div>
      `,
    };
