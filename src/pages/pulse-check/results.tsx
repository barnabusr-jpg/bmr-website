        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 border-b border-slate-900 pb-12">
            <div className="space-y-4">
              ...
              <h1 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter leading-none text-white text-left">
          ...
          <section className="bg-slate-900/10 border-2 border-slate-900 p-10 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <div className="space-y-12 relative z-10">
              ...
              <div className="grid lg:grid-cols-2 gap-12 pt-12 border-t border-slate-900 text-left">
                <div className="space-y-8 text-left">
                   <div className="space-y-4 text-left">
                     <h4 className="text-[10px] font-mono text-slate-500 font-black tracking-widest uppercase text-left">DIAGNOSTIC SUMMARY</h4>
                     <p className="text-slate-400 text-sm font-bold leading-relaxed italic uppercase tracking-tight text-left">
                ...
                <div className="bg-red-950/5 border border-red-600/20 p-8 space-y-8 relative shadow-inner text-left">
                  ...
                  <div className="grid grid-cols-2 gap-8 pt-8 border-t border-red-600/10 text-left">
                    <div className="space-y-1 text-left">
                      <span className="text-[8px] font-mono font-bold text-slate-600 uppercase tracking-widest text-left">REWORK TAX</span>
                      <div className="text-sm font-black text-white italic text-left">${result.reworkTax.toFixed(1)}M</div>
                    </div>
                    <div className="space-y-1 text-left">
                      <span className="text-[8px] font-mono font-bold text-slate-600 uppercase tracking-widest text-left">SHADOW AI</span>
                      <div className="text-sm font-black text-white italic text-left">${result.shadowAI.toFixed(1)}M</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-10 pt-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-left">
               {roadmap[result.archetype]?.map((step, i) => (
                 <div key={i} className="bg-slate-900/20 border border-slate-900 p-8 flex gap-6 items-start hover:border-red-600/50 transition-all group text-left">
                    <span className="text-red-600 font-mono text-xl font-black italic">0{i+1}</span>
                    <div className="space-y-2 text-left">
                       <h5 className="text-xs font-black uppercase text-white tracking-widest italic text-left">{step.title}</h5>
                       <p className="text-slate-500 text-[11px] font-medium leading-relaxed uppercase tracking-tight italic text-left">{step.desc}</p>
                    </div>
                 </div>
               ))}
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 pt-12 text-center">
             ...
             <button 
                ...
                className="bg-red-600 text-white p-10 flex flex-col items-center justify-center hover:bg-white hover:text-black transition-all shadow-2xl group"
             >
          ...
          <footer className="pt-24 flex flex-col items-center gap-4 opacity-10 text-center">
            ...
            <span className="font-mono text-[8px] tracking-[0.6em] uppercase text-slate-500 italic text-center">SESSION TERMINATED // AUTHORIZED EYES ONLY</span>
          </footer>
