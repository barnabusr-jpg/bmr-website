    ...
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-red-600/30">
      ...
      <main className="pt-44 pb-24 px-6 text-left">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <header className="space-y-4 border-l-4 border-red-600 pl-8 text-left italic">
            <span className="text-red-600 font-mono text-[10px] font-black tracking-[0.3em] uppercase">{data.subtitle}</span>
            <h1 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter leading-none text-left italic">{data.title}</h1>
          </header>
          <div className="grid md:grid-cols-3 gap-8 pt-12 border-t border-slate-900 text-left">
            <div className="md:col-span-2 space-y-8 text-left">
              <div className="bg-slate-900/40 p-8 border border-slate-800 rounded-sm text-left italic">
          ...
          <footer className="pt-16 flex flex-col items-center gap-4 opacity-10 text-center"><Activity className="text-red-600 animate-pulse" /><span className="font-mono text-[8px] tracking-[0.6em] text-slate-500 text-center">END OF AUTOPSY NODE-SEC-04</span></footer>
        </div>
      </main>
      <Footer />
    </div>
