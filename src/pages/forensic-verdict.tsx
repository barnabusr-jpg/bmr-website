...
export default function ForensicVerdict() {
  ...
  useEffect(() => {
    // 🔍 PERSISTENCE BRIDGE: Retrieve the lens saved by DeepDiveDiagnostic
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white py-24 px-6 font-sans">
      ...
      <div className="container mx-auto max-w-4xl mt-12">
        <header className="flex justify-between items-start border-b border-slate-900 pb-8 mb-12">
          <section>
            ...
            <div className="flex gap-4 mt-2">
              <span className="text-slate-500 font-mono text-[10px] uppercase tracking-widest font-black italic">AUDIT {data.sectorLabel}</span>
              <span className="text-slate-500 font-mono text-[10px] uppercase tracking-widest font-black italic">STATUS VALIDATED</span>
            </div>
          </section>
          <Lock className="text-slate-700" size={24} />
        </header>

        {/* 🛠️ THE PERSPECTIVE NODE ROW: This is the missing piece */}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 pt-12 border-t border-red-600/30 font-sans">
          <article>
          ...
          <Card className="bg-slate-950 p-8 border-l-4 border-red-600 rounded-none border-t-0 border-r-0 border-b-0 shadow-none">
            <div className="flex justify-between mb-4 font-mono text-[10px] text-slate-500 uppercase tracking-widest font-black">
              <span>VISIBLE TIP</span>
              <span>$1.2M</span>
            </div>
            <div className="h-px bg-slate-900 mb-4" />
            <div className="flex justify-between font-mono text-xs text-red-600 font-black tracking-widest italic">
        ...
        <footer className="bg-red-600 p-12 text-center shadow-[0_0_50px_rgba(220,38,38,0.2)]">
          ...
          <button className="bg-black text-white px-12 py-6 font-black uppercase italic tracking-[0.3em] text-[11px] hover:bg-white hover:text-black transition-all flex items-center justify-center gap-4 mx-auto border border-black font-sans">
