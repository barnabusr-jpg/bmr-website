...
export default function ForensicVerdict() {
  ...
  const activeMetrics = useMemo(() => {
    ...
    return {
      ...
      ghostFTEs: Math.max(1, Math.round(fteCount * reworkPercent)),
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-white p-12 mb-16 border-l-[16px] border-red-600 shadow-2xl">
          <div className="flex justify-between items-center mb-10 border-b border-slate-100 pb-6">
            <h2 className="text-black text-4xl font-black uppercase italic tracking-tighter leading-none italic">Executive Briefing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-slate-800">
            <div className="space-y-3">
              ...
              <p className="text-[15px] font-bold leading-relaxed uppercase italic">Wasting <span className="text-red-600 text-xl">{activeMetrics.wasteRatio.toFixed(0)}%</span> of total engineering capacity.</p>
            </div>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              <span className="text-[11px] font-black uppercase text-red-600 tracking-widest font-mono italic">Inaction Risk</span>
              <p className="text-[15px] font-bold leading-relaxed uppercase italic">Exposes <span className="text-red-600 text-xl">${activeMetrics.inactionPenalty.toLocaleString(undefined, {maximumFractionDigits:0})}</span> to collapse.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
          ...
          <div className="bg-red-950/20 border-2 border-red-600/50 p-12 flex flex-col justify-center">
            ...
            <div className="text-[11px] font-mono text-red-400 uppercase font-black tracking-widest mt-6 italic">12-Month Drift Penalty</div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="space-y-6">
              <div className="flex justify-between items-end">
                <span className="text-[11px] font-mono text-slate-500 uppercase font-black italic">Capital Spend</span>
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-end">
                <span className="text-[11px] font-mono text-slate-500 uppercase font-black italic">Team Size</span>
        ...
        <div 
          className="bg-white p-16 flex flex-col md:flex-row justify-between items-center gap-12 hover:bg-slate-100 transition-all border-l-[20px] border-red-600 cursor-pointer shadow-2xl" 
        ...
        >
          <div className="text-left">
            ...
            <p className="text-slate-600 text-[13px] font-black uppercase tracking-widest mt-6 italic leading-relaxed max-w-md italic">Schedule your forensic briefing to recover lost capacity and harden your AI roadmap.</p>
          </div>
