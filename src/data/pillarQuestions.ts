import { TriangulatedQuestion } from '../types/bmr';

export const pillarQuestions: Record<string, TriangulatedQuestion> = {
  // ===========================================================================
  // PILLAR 1: HUMAN-AUTONOMOUS INTERACTION [HAI] (QUESTIONS 01-30)
  // ===========================================================================
  
  // --- HAI: EXECUTIVE NODE (GOVERNANCE & STRATEGY) ---
  "HAI-01-EXEC": {
    id: "HAI-01-EXEC", pillar: "HAI", subarea: "Automated Verification Loops", target_node: "EXECUTIVE",
  ...
  "HAI-02-EXEC": {
    id: "HAI-02-EXEC", pillar: "HAI", subarea: "System Reskilling & Fallbacks", target_node: "EXECUTIVE",
  ...
  "HAI-03-EXEC": {
    id: "HAI-03-EXEC", pillar: "HAI", subarea: "Fiduciary Boundary Hardening", target_node: "EXECUTIVE",
  ...
  "HAI-04-EXEC": {
    id: "HAI-04-EXEC", pillar: "HAI", subarea: "Capital Allocation Transparency", target_node: "EXECUTIVE",
  ...
  "HAI-05-EXEC": {
    id: "HAI-05-EXEC", pillar: "HAI", subarea: "Access Governance Hierarchies", target_node: "EXECUTIVE",
  ...
  "HAI-06-EXEC": {
    id: "HAI-06-EXEC", pillar: "HAI", subarea: "Strategic Trust Calibration", target_node: "EXECUTIVE",
  ...
  "HAI-07-EXEC": {
    id: "HAI-07-EXEC", pillar: "HAI", subarea: "Autonomous Scale Thresholds", target_node: "EXECUTIVE",
  ...
  "HAI-08-MGMT": {
    id: "HAI-08-MGMT", pillar: "HAI", subarea: "Telemetry Noise Saturation", target_node: "MANAGERIAL",
  ...
  "HAI-09-MGMT": {
    id: "HAI-09-MGMT", pillar: "HAI", subarea: "Cross-Node Error Escalation", target_node: "MANAGERIAL",
  ...
  "HAI-10-MGMT": {
    id: "HAI-10-MGMT", pillar: "HAI", subarea: "SLA Control Management", target_node: "MANAGERIAL",
  ...
  "HAI-11-MGMT": {
    id: "HAI-11-MGMT", pillar: "HAI", subarea: "Compliance Logic Translation", target_node: "MANAGERIAL",
  ...
  "HAI-12-MGMT": {
    id: "HAI-12-MGMT", pillar: "HAI", subarea: "Bandwidth Leakage Allocation", target_node: "MANAGERIAL",
  ...
  "HAI-13-MGMT": {
    id: "HAI-13-MGMT", pillar: "HAI", subarea: "Third-Party Integration Safety", target_node: "MANAGERIAL",
  ...
  "HAI-14-MGMT": {
    id: "HAI-14-MGMT", pillar: "HAI", subarea: "Intervention Intercept Controls", target_node: "MANAGERIAL",
  ...
  "HAI-15-MGMT": {
    id: "HAI-15-MGMT", pillar: "HAI", subarea: "Internal Governance Documentation", target_node: "MANAGERIAL",
  ...
  "HAI-16-TECH": {
    id: "HAI-16-TECH", pillar: "HAI", subarea: "Deterministic Exception Intercepts", target_node: "TECHNICAL",
  ...
  "HAI-17-TECH": {
    id: "HAI-17-TECH", pillar: "HAI", subarea: "Alert Telemetry Hardening", target_node: "TECHNICAL",
  ...
  "HAI-18-TECH": {
    id: "HAI-18-TECH", pillar: "HAI", subarea: "Non-Repudiation Ledgers", target_node: "TECHNICAL",
  ...
  "HAI-19-TECH": {
    id: "HAI-19-TECH", pillar: "HAI", subarea: "Access Control Token Security", target_node: "TECHNICAL",
  ...
  "HAI-20-TECH": {
    id: "HAI-20-TECH", pillar: "HAI", subarea: "Idempotency Architecture Specs", target_node: "TECHNICAL",
  ...
  "HAI-21-TECH": {
    id: "HAI-21-TECH", pillar: "HAI", subarea: "Regression Testing Coverage", target_node: "TECHNICAL",
  ...
  "HAI-22-TECH": {
    id: "HAI-22-TECH", pillar: "HAI", subarea: "Data Lineage Resolution", target_node: "TECHNICAL",
  ...
  "HAI-23-USER": {
    id: "HAI-23-USER", pillar: "HAI", subarea: "Automation Bias Exploitation", target_node: "USER",
  ...
  "HAI-24-USER": {
    id: "HAI-24-USER", pillar: "HAI", subarea: "Workforce Workaround Tracks", target_node: "USER",
  ...
  "HAI-25-USER": {
    id: "HAI-25-USER", pillar: "HAI", subarea: "Explainability Gap Friction", target_node: "USER",
  ...
  "HAI-26-USER": {
    id: "HAI-26-USER", pillar: "HAI", subarea: "Alarm Dismissal Routines", target_node: "USER",
  ...
  "HAI-27-USER": {
    id: "HAI-27-USER", pillar: "HAI", subarea: "User Trust Disconnection", target_node: "USER",
  ...
  "HAI-28-USER": {
    id: "HAI-28-USER", pillar: "HAI", subarea: "Interface Sync Delays", target_node: "USER",
  ...
  "HAI-29-USER": {
    id: "HAI-29-USER", pillar: "HAI", subarea: "Manual Override Friction", target_node: "USER",
  ...
  "HAI-30-USER": {
    id: "HAI-30-USER", pillar: "HAI", subarea: "Onboarding Training Drift", target_node: "USER",
  ...
  "AVS-01-EXEC": {
    id: "AVS-01-EXEC", pillar: "AVS", subarea: "Data Infrastructure Foundations", target_node: "EXECUTIVE",
  ...
  "AVS-02-EXEC": {
    id: "AVS-02-EXEC", pillar: "AVS", subarea: "Velocity Scaling Matrices", target_node: "EXECUTIVE",
  ...
  "AVS-03-EXEC": {
    id: "AVS-03-EXEC", pillar: "AVS", subarea: "Resource Waste Optimization", target_node: "EXECUTIVE",
  ...
  "AVS-04-EXEC": {
    id: "AVS-04-EXEC", pillar: "AVS", subarea: "Composable Design Standards", target_node: "EXECUTIVE",
  ...
  "AVS-05-EXEC": {
    id: "AVS-05-EXEC", pillar: "AVS", subarea: "Multi-Cloud Interoperability", target_node: "EXECUTIVE",
  ...
  "AVS-06-EXEC": {
    id: "AVS-06-EXEC", pillar: "AVS", subarea: "Portfolio Modernization Planning", target_node: "EXECUTIVE",
  ...
  "AVS-07-EXEC": {
    id: "AVS-07-EXEC", pillar: "AVS", subarea: "Synthetic Data Risk Management", target_node: "EXECUTIVE",
  ...
  "AVS-08-MGMT": {
    id: "AVS-08-MGMT", pillar: "AVS", subarea: "Upstream Mutation Tracking", target_node: "MANAGERIAL",
  ...
  "AVS-09-MGMT": {
    id: "AVS-09-MGMT", pillar: "AVS", subarea: "Delivery Constraint Calibration", target_node: "MANAGERIAL",
  ...
  "AVS-10-MGMT": {
    id: "AVS-10-MGMT", pillar: "AVS", subarea: "Tribal Memory Mitigations", target_node: "MANAGERIAL",
  ...
  "AVS-11-MGMT": {
    id: "AVS-11-MGMT", pillar: "AVS", subarea: "Cross-Functional Dependency Mapping", target_node: "MANAGERIAL",
  ...
  "AVS-12-MGMT": {
    id: "AVS-12-MGMT", pillar: "AVS", subarea: "SLA Latency Mitigation", target_node: "MANAGERIAL",
  ...
  "AVS-13-MGMT": {
    id: "AVS-13-MGMT", pillar: "AVS", subarea: "API Contract Tracking", target_node: "MANAGERIAL",
  ...
  "AVS-14-MGMT": {
    id: "AVS-14-MGMT", pillar: "AVS", subarea: "Engineering Budget Efficiency", target_node: "MANAGERIAL",
  ...
  "AVS-15-MGMT": {
    id: "AVS-15-MGMT", pillar: "AVS", subarea: "Regression Controls Governance", target_node: "MANAGERIAL",
  ...
  "AVS-16-TECH": {
    id: "AVS-16-TECH", pillar: "AVS", subarea: "Polymorphic Validation Intercepts", target_node: "TECHNICAL",
  ...
  "AVS-17-TECH": {
    id: "AVS-17-TECH", pillar: "AVS", subarea: "Idempotent Stream Processing", target_node: "TECHNICAL",
  ...
  "AVS-18-TECH": {
    id: "AVS-18-TECH", pillar: "AVS", subarea: "Non-Blocking Message Buffers", target_node: "TECHNICAL",
  ...
  "AVS-19-TECH": {
    id: "AVS-19-TECH", pillar: "AVS", subarea: "Read Replica Decoupling", target_node: "TECHNICAL",
  ...
  "AVS-20-TECH": {
    id: "AVS-20-TECH", pillar: "AVS", subarea: "Active-Active Disaster Recovery", target_node: "TECHNICAL",
    ...
    choices: {
      ...
      B: { key: 'B', text: "Manual Image Spin-Ups: Infrastructure personnel provision secondary container images manually from image stores, introducing substantial recovery delays.", symptom_weight: 0.5, bandwidth_multiplier: 1.1 },
  ...
  "AVS-21-TECH": {
    id: "AVS-21-TECH", pillar: "AVS", subarea: "Cache Invalidation Webhooks", target_node: "TECHNICAL",
    symptomatic_scenario: "How are runtime caching engines validated to prevent old data properties from skewing decision algorithms?",
    choices: {
  ...
  "AVS-22-TECH": {
    id: "AVS-22-TECH", pillar: "AVS", subarea: "Distributed Serialization Normalizers", target_node: "TECHNICAL",
  ...
  "AVS-23-USER": {
    id: "AVS-23-USER", pillar: "AVS", subarea: "Manual Scrubbing Taxes", target_node: "USER",
  ...
  "AVS-24-USER": {
    id: "AVS-24-USER", pillar: "AVS", subarea: "Interface Data Loss Discrepancies", target_node: "USER",
  ...
  "AVS-25-USER": {
    id: "AVS-25-USER", pillar: "AVS", subarea: "Typing Error Disconnects", target_node: "USER",
    symptomatic_scenario: "When an external microservice modification updates database types, select the layout impact on user tasks.",
    choices: {
  ...
  "AVS-26-USER": {
    id: "AVS-26-USER", pillar: "AVS", subarea: "Duplicate Record Skews", target_node: "USER",
  ...
  "AVS-27-USER": {
    id: "AVS-27-USER", pillar: "AVS", subarea: "Character Encoding Distortions", target_node: "USER",
  ...
  "AVS-28-USER": {
    id: "AVS-28-USER", pillar: "AVS", subarea: "Database Indexing Latency", target_node: "USER",
  ...
  "AVS-29-USER": {
    id: "AVS-29-USER", pillar: "AVS", subarea: "Cache State Contention", target_node: "USER",
  ...
  "AVS-30-USER": {
    id: "AVS-30-USER", pillar: "AVS", subarea: "Outage Data Recovery", target_node: "USER",
  ...
  // ===========================================================================
  // PILLAR 3: INSTITUTIONAL GOVERNANCE/FIDELITY [IGF] (QUESTIONS 61-90)
  // ===========================================================================
  ...
  "IGF-03-EXEC": {
    ...
    choices: {
      ...
      B: { key: 'B', text: "Scripted Data Cleansing: Custom developer pipelines strip explicit identifiers like name tags, but preserve secondary matching variables.", symptom_weight: 0.4, bandwidth_multiplier: 0.9 },
  ...
  "IGF-09-MGMT": {
    ...
    symptomatic_scenario: "When an individual executes an erasure request, describe how management audits compliance across backup networks.",
    choices: {
  ...
  "IGF-11-MGMT": {
    ...
    choices: {
      ...
      C: { key: 'C', text: "Unhandled Data Transformations: Teams alter data schemas inside independent code blocks, creating untraceable data properties.", symptom_weight: 1.5, bandwidth_multiplier: 2.2, regulatory_tag: "Data Lineage Structural Failure" },
  ...
  "IGF-14-MGMT": {
    ...
    choices: {
      ...
      C: { key: 'C', text: "Ungated Code Merges: Developers edit model constraint metrics inline inside files without linking changes to compliance sign-off logs.", symptom_weight: 1.5, bandwidth_multiplier: 2.1, regulatory_tag: "SOX 404 Internal Controls Non-Compliance" },
  ...
  "IGF-16-TECH": {
    ...
    choices: {
      ...
      C: { key: 'C', text: "Mutable Local Storage: Records save as plaintext system files on local application nodes, mutable by users with root permissions.", symptom_weight: 1.6, bandwidth_multiplier: 2.4, regulatory_tag: "SEC Information Security Non-Compliance" },
      D: { key: 'D', text: "Temporary Cache Buffers: Logs write to rolling server memory stores that clear out completely during container updates.", symptom_weight: 2.0, bandwidth_multiplier: 3.5, regulatory_tag: "FINRA Rule 4511 Permanent Record Deletion" }
    }
  },
  "IGF-17-TECH": {
    id: "IGF-17-TECH", pillar: "IGF", subarea: "Deterministic Sandbox Replays", target_node: "TECHNICAL",
    symptomatic_scenario: "Calculate the technical labor latency required to reproduce an identical historical software state inside staging mirrors following an operational failure.",
    choices: {
      A: { key: 'A', text: "Automated Environment Replays: Sandbox environments use isolated historical snapshots, reproducing states within 2 hours.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Database Image Cloning: Staging replicas pull backup images but struggle to synchronize transaction parameters to precise code times.", symptom_weight: 0.4, bandwidth_multiplier: 1.0 },
      C: { key: 'C', text: "Indeterminate System Re-creation: State reproductions take weeks because platform logic is linked to external live data streams.", symptom_weight: 1.5, bandwidth_multiplier: 2.5, regulatory_tag: "State Reconstructibility Infrastructure Void" },
      D: { key: 'D', text: "Production-Only Debugging: Staging environments are unconfigured; engineering runs troubleshooting patches straight inside live systems.", symptom_weight: 2.0, bandwidth_multiplier: 3.2, regulatory_tag: "Regression Testing Operational Control Failure" }
    }
  },
  "IGF-18-TECH": {
    id: "IGF-18-TECH", pillar: "IGF", subarea: "Boundary Exception Guards", target_node: "TECHNICAL",
    symptomatic_scenario: "An autonomous scoring agent encounters an unexpected out-of-bounds metrics profile that matches zero internal validation rules. Review system behavior.",
    choices: {
      A: { key: 'A', text: "Deterministic Reversion Circuits: Edge middleware catches out-of-bounds values, pauses execution lanes, and alerts risk nodes.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Default Value Conversions: Logic layers convert exception values to zero properties, passing inaccurate tracking data downstream.", symptom_weight: 0.6, bandwidth_multiplier: 1.3 },
      C: { key: 'C', text: "Unconstrained Model Extrapolation: System processes data using automated inference rules, outputting untracked choices blindly.", symptom_weight: 1.4, bandwidth_multiplier: 2.3, regulatory_tag: "Boundary Exception Infrastructure Failure" },
      D: { key: 'D', text: "Cascading Queue Halts: Processing loops freeze indefinitely on calculation errors, blocking adjacent ingestion networks.", symptom_weight: 2.0, bandwidth_multiplier: 3.4, regulatory_tag: "Mathematical Range Control Validation Failure" }
    }
  },
  "IGF-19-TECH": {
    id: "IGF-19-TECH", pillar: "IGF", subarea: "Versioned Configuration Trees", target_node: "TECHNICAL",
    symptomatic_scenario: "How are algorithm threshold parameters and control plane variables logged across active cloud container systems?",
    choices: {
      A: { key: 'A', text: "Declarative Git-Ops Mapping: Variables save in versioned configuration files, logging value shifts over time.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Server State Backups: System configurations capture full server state logs daily, requiring file extraction to view edits.", symptom_weight: 0.4, bandwidth_multiplier: 0.9 },
      C: { key: 'C', text: "Mutable Local Variables: Settings update directly on running containers; environment histories reset during new image updates.", symptom_weight: 1.5, bandwidth_multiplier: 2.2, regulatory_tag: "Configuration Tracking Operational Control Void" },
      D: { key: 'D', text: "Undocumented Terminal Tuning: Parameters are adjusted ad-hoc by technicians via command lines with zero centralized logging entry.", symptom_weight: 2.0, bandwidth_multiplier: 3.0, regulatory_tag: "Change Control Policy Compliance Fracture" }
    }
  },
  "IGF-20-TECH": {
    id: "IGF-20-TECH", pillar: "IGF", subarea: "Serializable Transaction Chains", target_node: "TECHNICAL",
    symptomatic_scenario: "What multi-node protection design configuration blocks data overwrites when parallel database write pipelines experience connection contention?",
    choices: {
      A: { key: 'A', text: "Serializable Isolation Constraints: Relational write rules execute strict transaction ordering, locking rows to block overwrites.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Database Query Retries: Codebase layers catch deadlock logs, running automated transaction script re-tries until rows clear.", symptom_weight: 0.5, bandwidth_multiplier: 1.0 },
      C: { key: 'C', text: "Silent Operation Overwrites: Collisions process with zero alerts, writing mismatched state details straight to table arrays.", symptom_weight: 1.6, bandwidth_multiplier: 2.6, regulatory_tag: "Database Concurrency Control Deficit" },
      D: { key: 'D', text: "Permanent Relational Deadlocks: Resource contentions lock database connection channels globally, crashing container systems under load.", symptom_weight: 2.0, bandwidth_multiplier: 3.3, regulatory_tag: "Database Concurrency Control Deficit" }
    }
  },
  "IGF-21-TECH": {
    id: "IGF-21-TECH", pillar: "IGF", subarea: "Cryptographic Dependency Locking", target_node: "TECHNICAL",
    symptomatic_scenario: "An external open-source code package used by your automated platform receives a version patch. Detail your build pipeline's verification rule.",
    choices: {
      A: { key: 'A', text: "Strict Package Hash Enforcement: Build definitions check unique cryptographic signatures, blocking updates on signature changes.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Vulnerability Scanning Automation: Security runners scan code additions automatically before authorizing production deployments.", symptom_weight: 0.4, bandwidth_multiplier: 1.1 },
      C: { key: 'C', text: "Blind Remote Package Upgrades: Deployment tools pull current package versions straight from public clouds, ignoring code injection risks.", symptom_weight: 1.5, bandwidth_multiplier: 2.4, regulatory_tag: "Supply Chain Malicious Injection Risk" },
      D: { key: 'D', text: "Unhardened Core Dependencies: External scripts run with root system permissions, allowing unindexed data traversal across tables.", symptom_weight: 2.0, bandwidth_multiplier: 3.6, regulatory_tag: "Continuous Integration Vulnerability Control Failure" }
    }
  },
  "IGF-22-TECH": {
    id: "IGF-22-TECH", pillar: "IGF", subarea: "Agnostic Polymorphic Abstractions", target_node: "TECHNICAL",
    symptomatic_scenario: "What architecture pattern decouples core transaction logic parameters from platform-specific vendor query syntaxes?",
    choices: {
      A: { key: 'A', text: "Abstracted Storage Interfaces: Codebases connect to standard database drivers exclusively, letting systems switch platforms smoothly.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Decoupled Data Translators: Custom adapters convert query parameters manually, requiring development refactoring during migrations.", symptom_weight: 0.5, bandwidth_multiplier: 0.9 },
      C: { key: 'C', text: "Proprietary Schema Saturation: Rules rely on vendor-specific features, making code migration to alternative clouds unfeasible.", symptom_weight: 1.3, bandwidth_multiplier: 1.8, regulatory_tag: "Business Continuity Strategic Control Failure" },
      D: { key: 'D', text: "Siloed Vendor Processing: System operations execute within external vendor applications, completely outside internal code controls.", symptom_weight: 2.0, bandwidth_multiplier: 2.9, regulatory_tag: "System Traceability Infrastructure Void" }
    }
  },

  // --- IGF: FUNCTIONAL USER NODE (SYSTEM OPERATIONS) ---
  "IGF-23-USER": {
    id: "IGF-23-USER", pillar: "IGF", subarea: "Explainability Gap Exceptions", target_node: "USER",
    symptomatic_scenario: "When an automated scoring model denies an individual entity a service tier, what asset lets your team process a legal logic challenge?",
    choices: {
      A: { key: 'A', text: "One-Click Audit Manifests: The operator screen includes an automated reporting tool that prints clear decision details transiently.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Technical Variable Blocks: The interface displays validation sub-scores and metadata IDs that operators struggle to explain to clients.", symptom_weight: 0.5, bandwidth_multiplier: 1.2 },
      C: { key: 'C', text: "The Rationale Vacuum: Platforms display generic rejection codes with zero logic history, forcing staff to manually guess decision weights.", symptom_weight: 1.6, bandwidth_multiplier: 2.5, regulatory_tag: "GDPR Article 22 Infraction" },
      D: { key: 'D', text: "Total System Blindness: User screens provide zero track of transaction choices, forcing users to escalate disputes straight to legal teams.", symptom_weight: 2.0, bandwidth_multiplier: 3.8, regulatory_tag: "EU GDPR Non-Compliance" }
    }
  },
  "IGF-24-USER": {
    id: "IGF-24-USER", pillar: "IGF", subarea: "Plaintext Log Overwrites", target_node: "USER",
    symptomatic_scenario: "Review your operational team's workaround routine when historical tracking data parameters are cleared from screen views due to server rotation limits.",
    choices: {
      A: { key: 'A', text: "Zero Tracking Gaps: Relational histories persist permanently inside dedicated compliance viewers with no time limits applied.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Manual Ticket Requests: Staff ask data architects to extract historical text archives from cloud storage servers manually.", symptom_weight: 0.4, bandwidth_multiplier: 1.0 },
      C: { key: 'C', text: "The Shadow Spreadsheet Patch: Users maintain private Excel databases containing account decision histories to verify past actions safely.", symptom_weight: 1.5, bandwidth_multiplier: 2.6, regulatory_tag: "Shadow Data Pipeline Expansion" },
      D: { key: 'D', text: "Total Operational Amnesia: Staff process recurring business transactions with zero access to historical account decision configurations.", symptom_weight: 2.0, bandwidth_multiplier: 3.4, regulatory_tag: "SEC Cybersecurity Disclosures Failure" }
    }
  },
  "IGF-25-USER": {
    id: "IGF-25-USER", pillar: "IGF", subarea: "Uninsulated Text Logging", target_node: "USER",
    symptomatic_scenario: "When processing unstructured client feedback text strings inside system portals, how is private personal information hidden from view?",
    choices: {
      A: { key: 'A', text: "Automated Edge Redaction: Security filters strip names, credit cards, and addresses dynamically before values hit user screens.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Regex Clean Blocks: Central filters mask standard number sequences like account codes but regularly miss unformatted message inputs.", symptom_weight: 0.5, bandwidth_multiplier: 1.0 },
      C: { key: 'C', text: "Uninsulated Plaintext Display: Raw customer chat profiles print directly to open monitoring terminals, visible to general operations staff.", symptom_weight: 1.6, bandwidth_multiplier: 2.3, regulatory_tag: "Data Privacy Compliance Enforcement Risk" },
      D: { key: 'D', text: "Total Identity Exposure: Private profile variables stream to public vendor feedback trackers with no masking or encryption applied.", symptom_weight: 2.0, bandwidth_multiplier: 3.2, regulatory_tag: "HIPAA / GDPR Data Privacy Breach" }
    }
  },
  "IGF-26-USER": {
    id: "IGF-26-USER", pillar: "IGF", subarea: "Insider Download Habits", target_node: "USER",
    symptomatic_scenario: "Evaluate the capability of an internal platform operator to extract and save customer ledger lists to local storage devices.",
    choices: {
      A: { key: 'A', text: "Zero Export Rights: Interface profiles deactivate data export buttons globally, locking data view fields to secure environments.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Logged Size Caps: Export tools track downloads exceeding 5,000 rows, but allow users to split data extractions into smaller subsets.", symptom_weight: 0.4, bandwidth_multiplier: 0.9 },
      C: { key: 'C', text: "Ungated File Exporting: System views allow large data exports to local devices without triggering multi-factor checks.", symptom_weight: 1.5, bandwidth_multiplier: 2.4, regulatory_tag: "Insider Threat Capital Protection Failure" },
      D: { key: 'D', text: "Unlogged Bulk Copying: Staff can pull complete database histories straight to personal cloud storage routes with zero trace logs.", symptom_weight: 2.0, bandwidth_multiplier: 3.5, regulatory_tag: "ISO 27001 Access Control Control Failure" }
    }
  },
  "IGF-27-USER": {
    id: "IGF-27-USER", pillar: "IGF", subarea: "Geographic Account Splitting", target_node: "USER",
    symptomatic_scenario: "When managing accounts across international sovereignty zones, where are individual transaction processing locations visible to users?",
    choices: {
      A: { key: 'A', text: "Explicit Location Banners: Interface rows include clear regional data badges, confirming localized server hosting boundaries.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Static System Settings: System profiles state broad cloud region names but lack real-time container hosting information.", symptom_weight: 0.5, bandwidth_multiplier: 0.8 },
      C: { key: 'C', text: "Unmapped Data Spreads: Transactions process across multi-tenant regions dynamically without printing location metrics to screens.", symptom_weight: 1.4, bandwidth_multiplier: 2.0, regulatory_tag: "Data Sovereignty Compliance Transgression Risk" },
      D: { key: 'D', text: "Complete Location Opacity: Interface panels strip spatial tracking data entirely, masking cross-border data movements from operators.", symptom_weight: 2.0, bandwidth_multiplier: 2.9, regulatory_tag: "Cross-Border Sovereign Regulatory Infraction" }
    }
  },
  "IGF-28-USER": {
    id: "IGF-28-USER", pillar: "IGF", subarea: "Change Control Dissociation", target_node: "USER",
    symptomatic_scenario: "When an automated rule tweak modifies maximum transactional bounds on your operations screen, what change notice prints to views?",
    choices: {
      A: { key: 'A', text: "Version Control Banners: System views display an integrated change notification linking variables straight to risk signatures.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "General Policy Memos: Management distributes structural rule updates via internal corporate email threads or team channels.", symptom_weight: 0.4, bandwidth_multiplier: 1.0 },
      C: { key: 'C', text: "Undocumented Limit Shifts: Operational bounds change on screens without notification, forcing staff to discover rule caps inline.", symptom_weight: 1.6, bandwidth_multiplier: 2.5, regulatory_tag: "Change Control Policy Compliance Fracture" },
      D: { key: 'D', text: "Total Control Disconnect: Discrepancies between screen limits and corporate guidelines require manual data checking against legacy sheets.", symptom_weight: 2.0, bandwidth_multiplier: 3.2, regulatory_tag: "SOX 404 Infrastructure Gap" }
    }
  },
  "IGF-29-USER": {
    id: "IGF-29-USER", pillar: "IGF", subarea: "Shared Credential Abuse", target_node: "USER",
    symptomatic_scenario: "If an operator requires escalated administrative permissions to resolve an interface block, evaluate the authentication workflow.",
    choices: {
      A: { key: 'A', text: "Context-Bounded Identity Access: Identity platforms issue time-locked access parameters that expire in 15 minutes automatically.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Managerial Key Entry: Team leads unlock frozen views manually by inputting local administrative passwords on user devices.", symptom_weight: 0.5, bandwidth_multiplier: 0.9 },
      C: { key: 'C', text: "Shared Account Credentials: Users access collective master logins saved in plaintext files to clear interface constraints rapidly.", symptom_weight: 1.5, bandwidth_multiplier: 2.4, regulatory_tag: "Access Management Internal Control Failure" },
      D: { key: 'D', text: "Total Control Bypass: Terminal system interfaces allow clearing complex permission restrictions globally without logging individual user IDs.", symptom_weight: 2.0, bandwidth_multiplier: 3.1, regulatory_tag: "ISO 27001 Access Control Control Failure" }
    }
  },
  "IGF-30-USER": {
    id: "IGF-30-USER", pillar: "IGF", subarea: "Third-Party Data Drift", target_node: "USER",
    symptomatic_scenario: "An external database hosting provider scales down its infrastructure tier unannounced during low-traffic windows, causing processing delays.",
    choices: {
      A: { key: 'A', text: "Dynamic Edge Queue Buffering: Architecture catches slower response profiles, moving tasks to queues without dropping user connections.", symptom_weight: 0.0, bandwidth_multiplier: 0.0 },
      B: { key: 'B', text: "Manual Data Refreshing: Operators run continuous browser reloads manually to check if vendor endpoints have restored data connections.", symptom_weight: 0.4, bandwidth_multiplier: 0.8 },
      C: { key: 'C', text: "Uncaught Latency Spikes: Delay cascades through core applications, causing concurrent user disconnections across front-end viewports.", symptom_weight: 1.4, bandwidth_multiplier: 2.1, regulatory_tag: "SLA Operational Performance Guard Failure" },
      D: { key: 'D', text: "Silent Processing Failures: Slower response pipelines cause ingestion transactions to fail silently, corrupting target calculation ledgers.", symptom_weight: 2.0, bandwidth_multiplier: 3.0, regulatory_tag: "Catastrophic Supply Chain Collapse" }
    }
  }
};
